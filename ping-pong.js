...
(function () {
    ...
    if (rod === "null" || maxScore === "null") {
        alert("*This is the first time you are playing this game. LET'S START" + "\n"+ "*Use Left and Right Key to move rod left and Right");
        maxScore = 0;
        rod = "Rod1";
        
    } else {
        alert("*Use Left and Right Key to move rod left and Right"+"\n"+"*"+
            rod + " has maximum score of " + maxScore * 100);
    }
...
window.addEventListener('keydown', function (event) {
    ...
    if ((event.code === "ArrowRight" || event.code === "KeyD" ) && ((rodRect.x + rodRect.width) < window.innerWidth)) {
        rod1.style.left = (rodRect.x) + rodSpeed + 'px';
        rod2.style.left = rod1.style.left;
    } else if ((event.code === "ArrowLeft" || event.code === "KeyA") && (rodRect.x > 0)) {
        rod1.style.left = (rodRect.x) - rodSpeed + 'px';
        rod2.style.left = rod1.style.left;
    }
        ...
        if (!gameOn) {
            ...
            movement = setInterval(function () {
                ...
                if (ballY < rod1Height) {
                    ...
                    score++;
                    scoreValue.innerText=(score+1)*100;
